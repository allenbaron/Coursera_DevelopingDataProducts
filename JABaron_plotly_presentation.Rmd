---
title: "U.S. Baby Name Popularity, 1967-2017"
subtitle: "Presentation with Plotly\r\nDeveloping Data Products - Week 3"
...
- **NOTE:** To reduce complexity, only those names which reached #1 or #2 in _at least one year_ are included.
- For the code examine the original .Rmd file.

## Get Name Popularity Data | From U.S. Social Security Administration
...
Data was downloaded from the U.S. Social Security Administration on `r readRDS(file = "./plotly_data/dl_timestamp.Rdata")`.
...
## Popularity of Girls' Names over the Last 50 years

Only those girls' names that reached the Top 2 in at least one year are included.
```{r}
...
## Popularity of Boys' Names over the Last 50 years

Only those boys' names that reached the Top 2 in at least one year are included.
```{r}
